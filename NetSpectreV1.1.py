...
def main():
    ...
    print("   XX-----------------------------------------------------------XX")
    print("   XX------------------- NetSpectre v1.1 -----------------------XX")
    print("   XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")
    print("                                                                  ")
    print("                                                       -FurkanT   ")
    print("1 - Network Scanner")
    print("2 - Port Scanner (TCP)")
    print("3 - Wifi Scanner")
    print("q - Exit")
    print("")
    print("")
...
def wifi_scan():
    ...
    wifi = pywifi.PyWiFi()
    iface = wifi.interfaces()[0]  # İlk Wi-Fi arayüzünü seç

    iface.scan()  # Tarama başlat
    time.sleep(3)  # Bekle (ağları taraması zaman alır)
    ...
    print("   SSID                   BSSID                Signal         Auth            AKM          Cipher")
    print("----------------------------------------------------------------------------------------------------")
    ...
    for network in results:
        ...
        auth = AUTH_MAP.get(network.auth[0], "Unknown") if network.auth else "Unknown"
        akm = AKM_MAP.get(network.akm[0], "Unknown") if network.akm else "Unknown"
        cipher = CIPHER_MAP.get(network.cipher, "Unknown")


        print(f" {ssid}           {bssid}           {signal}           {auth}           {akm}           {cipher}")
        print("")
